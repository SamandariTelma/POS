...
String montant = GlobalVariable.prixIMEI //ex '1 000 000'

int montantAPayer = montant.replaceAll('\\s', '').toInteger( //devient 1000000
    )

String montantAPayerMGA = GlobalVariable.prixIMEI + ' MGA'
...
//RECHERCHE IMEI
'Renseigner le numéro de IMEI dans le champ IMEI/ICCID/EAN/SN '
WebUI.sendKeys(findTestObject('Page Vente POS-/Champ de saisie numero Imei ICCID EAN SN'), GlobalVariable.numeroIMEI)
...
WebUI.verifyElementAttributeValue(findTestObject('Page Vente POS-/Champ Libelle'), 'value', GlobalVariable.libelleIMEI, 
    3)

WebUI.verifyElementAttributeValue(findTestObject('Page Vente POS-/Champ Code'), 'value', GlobalVariable.codeArticleIMEI, 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page Vente POS-/Champ Code Sage'), 'value', GlobalVariable.codeSageIMEI, 
    0)

WebUI.verifyElementText(findTestObject('Page Vente POS-/Champ Type de serialisation'), 'IMEI')
...
WebUI.verifyElementText(findTestObject('Page Vente POS-/Panier en cours/Designation 1ere ligne'), ((GlobalVariable.libelleIMEI + 
    ' (') + GlobalVariable.numeroIMEI) + ')\nArticle')

WebUI.verifyElementText(findTestObject('Page Vente POS-/Panier en cours/Montant 1ere ligne'), GlobalVariable.prixIMEI + 
    ' MGA')
