...
WebUI.verifyElementPresent(findTestObject('Pages Gestion de stock/Page Sortie de stock/Bouton Sortie exeptionnelle'), 3)

WebUI.verifyElementPresent(findTestObject('Pages Gestion de stock/Page Sortie de stock/Bouton Ordre de rapatriement'), 3)

WebUI.verifyElementPresent(findTestObject('Pages Gestion de stock/Page Sortie de stock/Bouton Sortie de transfert'), 3)
