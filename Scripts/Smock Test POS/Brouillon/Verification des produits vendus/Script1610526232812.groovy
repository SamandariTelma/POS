...
System.out.println('Dans verification des produits vendus: ' + GlobalVariable.referenceDeTransaction)

WebUI.callTestCase(findTestCase('Smock Test POS/00 - Called Tests Case/Connexion a POS'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.sendKeys(findTestObject('Header POS-/Barre de recherche'), GlobalVariable.referenceDeTransaction)

WebUI.click(findTestObject('Header POS-/Bouton recherche'))
